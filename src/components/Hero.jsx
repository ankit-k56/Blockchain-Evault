...
const Hero = () => {
  return (
    <div className={`flex sm:flex-row flex-col items-center justify-between relative md:static  md:p-10 ${outfit.className}`}>
        ...
        <section className='font-bold space-y-5 md:space-y-12 py-5 md:py-16'>
            <h1 className='text-xl sm:text-3xl md:text-5xl'>Legal EVault</h1>
            <h1 className='text-base sm:text-xl md:text-3xl'>Blockchain based Legal Records E-Vault</h1>
        </section>
