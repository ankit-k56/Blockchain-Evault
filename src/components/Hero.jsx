...
const Hero = () => {
  return (
    <div className={`flex flex-col md:flex-row items-center  justify-between p-10 overflow-hidden relative ${outfit.className}`}>
        ...
        <section className='font-bold space-y-12 py-16'>
            <h1 className='text-5xl'>LegalChain Vault</h1>
            <h1 className='text-3xl'>Unlocking the Future of Legal Records</h1>
        </section>
