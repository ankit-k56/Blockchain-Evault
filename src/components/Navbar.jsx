...
const Navbar = () => {
  ...
  return (
    <nav className="flex justify-between md:px-4 lg:px-10 py-6 items-center px-4">
      ...
      />
      <ul
        className={`flex z-10 flex-col md:flex-row absolute md:static top-16 right-8 bg-gray-900 md:bg-transparent bg-opacity-90 rounded-md md:p-0 p-4 gap-8 md:gap-10 items-center ${
          showNavbar ? "block" : "md:flex hidden"
        }`}
      >
        <li>About us</li>
        <li>Contact us</li>
